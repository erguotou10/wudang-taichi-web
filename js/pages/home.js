...
export function renderHome(container) {
  ...
  container.innerHTML = `
    <div class="page active" id="page-home">
      ...
      <div class="quick-entry">
        ...
        <div class="quick-entry-item" data-action="culture">
        ...
        <div class="quick-entry-item" data-action="checkin">
      ...
      <div class="checkin-status">
        <div class="checkin-info">
          <div class="checkin-label">今日练习</div>
          <div class="checkin-days">已连续打卡 <span>5天</span></div>
        </div>
        <button class="checkin-btn" data-action="checkin">去打卡</button>
      </div>
    </div>
  `;
  ...
  container.querySelectorAll('[data-action]').forEach(el => {
    el.addEventListener('click', () => {
      ...
      if (action === 'culture') showToast('文化介绍模块开发中');
      if (action === 'checkin') showToast('打卡模块开发中');
    });
  });
